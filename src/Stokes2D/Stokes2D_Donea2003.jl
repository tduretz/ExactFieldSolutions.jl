...
Evaluates a manufactured solution from [Donea & Huerta (2003)](https://onlinelibrary.wiley.com/doi/book/10.1002/0470013826):
    ...
    params : optional parameter array, default = (η=1,)
and returns:
...
```julia-repl
julia> Stokes2D_Donea2003([1/4,1/4])
(p = 0.1875, V = [0.006591796875, -0.006591796875], L = [0.03515625 -0.0087890625; 0.0087890625 -0.03515625], ε̇ = [0.03515625 0.0; 0.0 -0.03515625], τ = [0.0703125 0.0; 0.0 -0.0703125], s = [0.7578125, -0.2578125])
```
"""
